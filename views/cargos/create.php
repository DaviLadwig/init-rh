...
<section class="catalog-page-header">
    ...
    <div class="catalog-page-header__content">
        ...
        <p>
            Cadastre um cargo formal ou contratual utilizado
            pelos colaboradores.
        </p>
...
<section class="catalog-form-card">
    ...
    <form
        method="POST"
        action="<?= escapar(appUrl('cargos/criar')) ?>"
        class="catalog-form"
        novalidate
    >
        ...
        <div class="catalog-form__section">
            ...
            <header class="catalog-form__section-header">
                ...
                <p>
                    Informe os dados utilizados para identificar o cargo.
                </p>
            </header>
        ...
        <div class="catalog-form__section">
            ...
            <header class="catalog-form__section-header">
                ...
                <p>
                    Defina se o cargo ficará disponível imediatamente.
                </p>
            </header>
            ...
            <label class="catalog-status-switch">
                ...
                <span class="catalog-status-switch__content">
                    ...
                    <small>
                        Cargos ativos poderão ser associados aos colaboradores.
                    </small>
                </span>
