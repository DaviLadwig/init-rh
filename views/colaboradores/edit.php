...
<section class="employees-page-header">
    ...
    <div class="employees-page-header__content">
        ...
        <p>
            Atualize os dados pessoais e funcionais de
        ...
        <div class="employees-form__section">
            ...
            <header class="employees-form__section-header">
                ...
                <div>
                    ...
                    <p>
                        Atualize os dados de identificação e
        ...
        <div class="employees-form__section">
            ...
            <header class="employees-form__section-header">
                ...
                <div>
                    ...
                    <p>
                        Atualize a matrícula e a posição do
        ...
        <div class="employees-form__section">
            ...
            <header class="employees-form__section-header">
                ...
                <div>
                    ...
                    <p>
                        Atualize a forma de contratação, jornada
                ...
                >
                    ...
                    <?php else: ?>
                        ...
                        <small
                            ...
                            data-end-date-help
                        >
                            Obrigatória para vínculos com prazo
                            determinado.
                        </small>
        ...
        <div class="employees-form__section">
            ...
            <header class="employees-form__section-header">
                ...
                <div>
                    ...
                    <p>
                        Atualize as observações internas e a
                ...
                <div class="employees-status-card">
                    ...
                    <label class="employees-status-switch">
                        ...
                        >
                            ...
                            <small>
                                Colaboradores inativos permanecem no
                                histórico, mas não ficam disponíveis
